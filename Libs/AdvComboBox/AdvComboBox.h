...
/////////////////////////////////////////////////////////////////////////////
// CAdvComboBoxMod window
#define ADVCOMBOBOXCTRLMOD_CLASSNAME    _T("AdvComboBoxCtrl")  // Window class name

class CAdvComboBoxMod : public CWnd
{
// Construction
public:
	CAdvComboBoxMod( BOOL bInst = FALSE );

	DECLARE_DYNAMIC(CAdvComboBoxMod)
...
private:
	void CreateDropList( list<LIST_ITEM_MOD> &droplist );
	void SelPrevItem();
	void SelNextItem();
	...
	CAdvDropWnd* m_pDropWnd;
	CRect m_rcDropButton;
	BOOL m_bDropListVisible;
	bool m_bDropRectStored;

	list<LIST_ITEM_MOD> m_list;
	list<LIST_ITEM_MOD>::iterator m_iter;
