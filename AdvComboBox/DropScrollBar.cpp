...
CAdvDropScrollBar::CAdvDropScrollBar()
:
m_pListBox( 0 )
{
}
...
BEGIN_MESSAGE_MAP(CAdvDropScrollBar, CScrollBar)
	//{{AFX_MSG_MAP(CAdvDropScrollBar)
	ON_WM_MOUSEMOVE()
...
/////////////////////////////////////////////////////////////////////////////
// CAdvDropScrollBar message handlers



void CAdvDropScrollBar::OnMouseMove(UINT nFlags, CPoint point) 
{
	//
...
void CAdvDropScrollBar::VScroll(UINT nSBCode, UINT nPos) 
{
...
void CAdvDropScrollBar::SetListBox( CAdvDropListBox* pListBox )
{
...
void CAdvDropScrollBar::OnLButtonDown(UINT nFlags, CPoint point) 
{
	CRect rc;
	GetClientRect( &rc );
